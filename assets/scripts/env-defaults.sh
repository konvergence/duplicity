...
export DAILY_BACKUP_MAX_FULL_WITH_INCR=${DAILY_BACKUP_MAX_FULL_WITH_INCR:-2}
export DAILY_BACKUP_MAX_FULL=${DAILY_BACKUP_MAX_FULL:-5}
...
export MONTHLY_MAX_FULL_BACKUP=${MONTHLY_MAX_FULL_BACKUP:-12}
